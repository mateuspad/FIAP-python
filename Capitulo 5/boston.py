with open("Capitulo 5\economic-indicators.csv", "r") as boston:
    total_voos = 0
    maior = 0
    total_passageiros = 0
    mes_maior_diaria = 0
    ...
    print("O mês/ano de maior movimento no aeroporto foi: ", str(mes), "/",
          str(ano))
    print("O total de passageiros do ano ", ano_usuario, "foi de ",
          total_passageiros)
